...
MAPA_INTELIGENCIAS = {
    ...
    'psique':      {'nome': 'Psique',       'cor_header': '#9c27b0', 'cor_detalhe': '#7b1fa2', 'cor_fundo_msg': '#f3e5f5', 'expert_id': 15, 'saudacao': 'Sou Psique. Psicologa relacional. O que habita seu íntimo?'},
